extends "res://addons/SphynxEnhancedCompositorToolkit/BaseClasses/enhanced_compositor_effect.gd"
class_name DebugCompositorEffect

@export var overlay_stage : ShaderStageResource = preload("res://addons/SphynxEnhancedCompositorToolkit/Debug/debug_overlay_shader_stage.tres"):
	set(value):
